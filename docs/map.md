...
| The desk rig — custom desk model, mixer, monitors, rack, Apollo Twin, lava lamp, radio | the `desk rig` block @6556 | `assets/models/{desk,apollo_twin}.glb`, `assets/img/desk_wood.webp`, `main.js` 1933–2010, `radio.js` |
