...
| The desk rig — custom desk model, mixer, monitors, D-Box, rack, Apollo Twin, Mac Studio, lava lamp, radio | `world.js` desk-rig block @6556; `main.js` layout editor @3868 | `assets/models/{desk,dbox,apollo_twin,mac_studio}.glb`, `assets/img/desk_wood.webp`, `main.js` 1933–2010, `radio.js` |
