...
em++ $SRC -I. -O2 -fno-exceptions -fno-rtti -DTEST \
  ...
  -sEXPORTED_FUNCTIONS=_mi_init,_pl_set,_pl_note_on,_pl_note_off,_pl_render,_pl_active,_cl_init,_cl_set,_cl_process,_cl_ptr \
  -sINITIAL_MEMORY=16777216 -sTOTAL_STACK=1048576 \
  -o "$SCRATCH/mi.wasm"
